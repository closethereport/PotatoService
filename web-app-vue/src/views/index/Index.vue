<template>
  <div class="header-container pt-4">
    <div class="px-4 py-8 md:px-6 lg:px-8">
      <div class="text-700 text-center">
        ...
        <div class="text-white text-2xl mb-5">Инновационное решение для автоматического создания документации</div>
        <Button label="Вход" icon="pi pi-sign-in" class="font-bold px-5 py-3 p-button-raised p-button-rounded white-space-nowrap"></Button>
  ...
  <div class="grid grid-nogutter surface-section text-800">
    ...
    <div class="col-12 md:col-6 overflow-hidden">
      <img
        src="https://images-na.ssl-images-amazon.com/images/I/61xVsCZnCuL.jpg"
        alt="Image"
